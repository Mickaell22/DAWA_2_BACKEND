...
from ....api.Components.Audit.AuditComponent import AuditComponent
class AuditService(Resource):
    @staticmethod
    def get():
        try:
            HandleLogs.write_log("Audit Table SQL")
            ...
            answer = AuditComponent.TablaAuditSQL()
